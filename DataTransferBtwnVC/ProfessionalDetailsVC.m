...
- (IBAction)profBtnActn:(id)sender {
    ...
    [self presentViewController:rvc animated:YES completion:^{
        ...
        rvc.firstNameRF.text = [[[[[[rvc.profArray objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:0];
        
        rvc.lastNameRF.text=[[[[[[rvc.profArray objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:1];
        
        rvc.ageRF.text=[[[[[[rvc.profArray objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:2];
        
        
        
        rvc.mobileNumRF.text = [[[[[rvc.profArray objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:1];
        
        rvc.emailIdRF.text=[[[[[rvc.profArray objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:2];
        
        rvc.whatsAppNumRF.text=[[[[[rvc.profArray objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:3];
        
        rvc.usrNamRF.text = [[[[rvc.profArray objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:1];
        rvc.pswdRF.text = [[[[rvc.profArray objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:2];
        rvc.confPswdRF.text = [[[[rvc.profArray objectAtIndex:0]objectAtIndex:0]objectAtIndex:0]objectAtIndex:3];
        
        rvc.btechPerRF.text = [[[rvc.profArray objectAtIndex:0]objectAtIndex:0]objectAtIndex:1];
        rvc.interPerRF.text = [[[rvc.profArray objectAtIndex:0]objectAtIndex:0]objectAtIndex:2];
        rvc.SSCPerRF.text = [[[rvc.profArray objectAtIndex:0]objectAtIndex:0]objectAtIndex:3];
        
        rvc.companyNamRF.text = [[rvc.profArray objectAtIndex:0]objectAtIndex:1];
        rvc.addressRF.text = [[rvc.profArray objectAtIndex:0]objectAtIndex:2];
        rvc.designtnRF.text = [[rvc.profArray objectAtIndex:0]objectAtIndex:3];
        rvc.salaryRF.text = [[rvc.profArray objectAtIndex:0]objectAtIndex:4];
